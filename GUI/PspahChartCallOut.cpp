...
PspahChartCallOut::PspahChartCallOut(QChart* chart) :
    QGraphicsItem(chart),
    chart(chart)
{
...
QRectF PspahChartCallOut::boundingRect() const
{
...
void PspahChartCallOut::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget* widget)
{
    Q_UNUSED(option)
        Q_UNUSED(widget)
...
void PspahChartCallOut::mousePressEvent(QGraphicsSceneMouseEvent* event)
{
    event->setAccepted(true);
}

void PspahChartCallOut::mouseMoveEvent(QGraphicsSceneMouseEvent* event)
{
...
void PspahChartCallOut::setText(const QString& text)
{
    this->text = text;
...
void PspahChartCallOut::setAnchor(QPointF point)
{
    anchor = point;
}

void PspahChartCallOut::updateGeometry()
{
    prepareGeometryChange();
